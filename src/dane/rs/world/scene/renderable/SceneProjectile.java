...
public final class SceneProjectile extends Renderable {
	...
	public SceneProjectile(int spotanim, int target, int sourceX, int sourceY, int sourceZ, int level, int firstTick, int lastTick, int arcScale, int elevationPitch, int baseZ) {
